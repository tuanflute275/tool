...
const consolePrefix = '%c [Bot] ';

const originalConsoleLog = console.log;

console.log = function () {
  if (arguments[0].includes('[Bot]') || arguments[0].includes('github.com')) {
...
console.clear();
// console.log(`${consolePrefix}Tải extension tại telegram @dancayairdrop...`, consoleGreen);
...
function findAndClick() {
    ...
    if (isBattle) {
        ...
        if (finishTextElement){
            ...
            console.log(`${consolePrefix}${finishCoins.includes('-') ? 'Bạn Thua' : 'Bạn Thắng'} (${finishCoins})`, finishCoins.includes('-') ? consoleRed : consoleGreen);  
            playBtn.click()
        }
    }
}
